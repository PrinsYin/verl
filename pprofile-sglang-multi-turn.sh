...
COMMAND="nohup env EXPERIMENT_NAME=${EXPERIMENT_NAME} bash examples/sglang_multiturn/run_qwen2_3b_dapo_multiturn.sh >> logs/dapo-multiturn-tp-${TP_SIZE}-${TIMESTAMP}.log 2>&1 &"
